...
- Elemento bruto
- Sem contexto
- Exemplo: `42`, `Azul`, `19/02/2026` { .fragment }
...
- Dado processado
- Com contexto
- Exemplo: `A temperatura agora é 42°C` { .fragment }
- Exemplo: `A cor favorita do João é Azul` { .fragment }
...
- Pense em uma biblioteca digital 📚 { .fragment }
...
- Exemplo: O bibliotecário que organiza as prateleiras 🤵 { .fragment }
...
- Anote em lugar seguro! 🛡️ { .fragment }
