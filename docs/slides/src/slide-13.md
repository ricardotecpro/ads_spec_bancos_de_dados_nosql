...
- **Dica**: Desenhe o banco pensando na tela do App! { .fragment }
...
- **Risco**: Dados duplicados. { .fragment }
...
- **Risco**: Precisa de mais de uma consulta ao banco. 🐢 { .fragment }
...
- Dados mudam muito? -> **Referencia** { .fragment }
...
- **Solução**: Mova para Referência! 🧱 { .fragment }
...
- Exibo a lista de posts sem precisar buscar os autores! 😎 { .fragment }
...
- Itens do pedido?
- Status de entrega?
- Vamos discutir a melhor estratégia para cada um. 🛒 { .fragment }
