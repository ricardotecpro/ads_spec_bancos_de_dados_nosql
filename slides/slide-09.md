...
- Ex: Pagamento via PIX 💸 <!-- .element: class="fragment" -->
...
- `ROLLBACK`: "Voltar para o início" (Desfazer) 🔙 <!-- .element: class="fragment" -->
...
5. Se ok -> `COMMIT`. <!-- .element: class="fragment" -->
...
- Sem meio-termo! <!-- .element: class="fragment" -->
...
- O banco é sempre um lugar organizado. 🏛️ <!-- .element: class="fragment" -->
...
- Pode acabar a luz, o servidor reiniciar... os dados estarão lá! 🔋 <!-- .element: class="fragment" -->
...
- Para unir vários, você deve usar o `BEGIN` manual. 🤝 <!-- .element: class="fragment" -->
...
- O alívio de ver os dados voltando! 😮💨 <!-- .element: class="fragment" -->
