...
- Precisamos da "ponte" para ver a foto completa! 📸 <!-- .element: class="fragment" -->
...
- Se o pedido não tem cliente, ele não aparece. <!-- .element: class="fragment" -->
...
- Traz todos os pedidos, mesmo que o cliente tenha sido apagado. <!-- .element: class="fragment" -->
...
- Tabela A (10 linhas) x Tabela B (10 linhas) = 100 linhas no resultado. <!-- .element: class="fragment" -->
...
```
- Atalhos que salvam vidas (e dedos)! ⌨️ <!-- .element: class="fragment" -->
...
- **LEFT JOIN** entre Alunos e Turmas! 🎓 <!-- .element: class="fragment" -->
