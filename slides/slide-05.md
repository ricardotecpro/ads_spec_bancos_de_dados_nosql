...
- Um define a estrutura, o outro o conteúdo! <!-- .element: class="fragment" -->
...
```
- Ordem das colunas importa! <!-- .element: class="fragment" -->
...
- Menos chance de erro de duplicidade! 🆔 <!-- .element: class="fragment" -->
...
```
- `SET`: O que mudar
- `WHERE`: Quem mudar 🎯 <!-- .element: class="fragment" -->
...
- Na vida real: Você pode ser demitido! 😅 <!-- .element: class="fragment" -->
...
- Não há botão "Desfazer" (fora de transações). 🔥 <!-- .element: class="fragment" -->
...
- Se o `SELECT` trouxer os dados certos, o `DELETE` também trará. 🛡️ <!-- .element: class="fragment" -->
...
- `SET preco = preco * 1.15` <!-- .element: class="fragment" -->
