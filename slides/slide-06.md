...
- O comando mais usado: `SELECT` 🔎 <!-- .element: class="fragment" -->
...
- Ele filtra as linhas que desejamos. 🎯 <!-- .element: class="fragment" -->
...
- `IN`: Em uma lista 🧺 <!-- .element: class="fragment" -->
...
- `ILIKE`: Busca sem diferenciar Maiúsculas/Minúsculas (PostgreSQL). <!-- .element: class="fragment" -->
...
- Pode ordenar por mais de uma coluna! <!-- .element: class="fragment" -->
...
- **Dica**: Liste as colunas! <!-- .element: class="fragment" -->
...
```
- Essencial para criar páginas no site (Paginação). 📄 <!-- .element: class="fragment" -->
