...
- Criar Índices de performance <!-- .element: class="fragment" -->
...
- Inserir Produtos
- Gerar Pedidos
- Simular Vendas <!-- .element: class="fragment" -->
...
- Ordenar relatórios <!-- .element: class="fragment" -->
...
- Garantir a integridade entre Estoque e Pedido <!-- .element: class="fragment" -->
...
- É o seu primeiro grande degrau como DBA! 🪜 <!-- .element: class="fragment" -->
...
- Existe algum pedido sem item? (Auditoria de erro) <!-- .element: class="fragment" -->
