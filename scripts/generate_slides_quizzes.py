...
<head>
    ...
    <title>Aula {lesson_number:02d} - Bancos de Dados SQL e NoSQL</title>
...
def generate_all_slides():
    ...
    for i in track(range(1, 17), description="Processando slides..."):
        ...
        if src_md_path.exists():
            ...
            content = re.sub(r'\{[ \t]*\.fragment[ \t]*\}', '<!-- .element: class="fragment" -->', content)
...
def main():
    print("[bold]🚀 Automação de Conteúdo: Bancos de Dados SQL e NoSQL[/bold]")
    print("=" * 50)
